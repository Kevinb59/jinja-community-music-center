/**
 * Textes et chemins d’images alignés sur index.html et js/script.js (i18n FR).
 */
export const paths = {
...
export const copy = {
  ...
  /** Nom affiché après l’année dans le copyright du footer. */
...
/** E-mail affiché dans les mentions légales (contact association). */
...
<div class="space-y-5 text-sm leading-7 text-slate-300">
  <div class="rounded-2xl border border-white/10 bg-white/5 p-5">
    ...
    <div class="mb-4">
      <p class="mb-1 text-xs font-semibold uppercase tracking-wide text-slate-500">Siège social</p>
      <p class="m-0">176 rue Jean Jaurès, appartement 2<br />59500 Douai – France</p>
    </div>
    <div class="mb-4">
      <p class="mb-1 text-xs font-semibold uppercase tracking-wide text-slate-500">Responsable de la publication</p>
      <p class="m-0">EMPIS EMILIE, Présidente de l'association</p>
    </div>
    <div class="m-0">
